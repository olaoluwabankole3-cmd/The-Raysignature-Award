...
export default function NomineesSection({ categories }: NomineesSectionProps) {
  ...
  if (!hasNomineesReleased) {
    return (
      <section className="relative w-full py-24 sm:py-36 bg-[#12072B] border-t border-zinc-900/40 overflow-hidden text-center">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 max-w-full sm:w-max mx-auto mb-6 py-2 px-3 sm:px-4 rounded-md border border-amber-400/30 bg-amber-500/[0.02] shadow-[0_0_10px_rgba(245,158,11,0.05)]">
              ...
              <span className="font-mono text-[8px] sm:text-[9px] tracking-normal sm:tracking-widest bg-gradient-to-r from-amber-200 via-yellow-300 to-amber-400 bg-clip-text text-transparent uppercase font-bold text-center leading-normal">
                CELEBRATING COOL CREATORS • VOTING OPENS SOON
              </span>
              <span className="w-1 h-1 rounded-full bg-amber-400 shrink-0" />
            </div>
 
            <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed max-w-md mx-auto mb-4 font-sans px-2 sm:px-0">
              Our team is currently choosing this year's top artists, designers, and creators to share with you soon!
            </p>
            <p className="text-[#d8b05c]/60 text-[10px] uppercase font-mono tracking-widest leading-loose px-2 sm:px-0 font-bold">
              You will be able to vote for your favorite ones as soon as we reveal the nominees!
            </p>
          </motion.div>
        </div>
      </section>
  ...
  return (
    ...
    >
      <div className="max-w-3xl mb-12 sm:mb-16 text-center md:text-left">
        ...
        <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-sans max-w-xl font-medium">
          Choose the creators you love the most from each group. Your votes will be saved right on your device so you won't lose them!
        </p>
      </div>
          ...
          return (
            ...
            >
              <div className="lg:col-span-1 max-w-md">
                ...
                {isCategoryVoted && (
                  <div className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-zinc-950 border border-zinc-900 text-emerald-400 font-mono text-[10px] tracking-wide uppercase animate-pulse font-bold">
                  ...
                  return (
                    ...
                    >
                      <div>
                          ...
                          <AnimatePresence>
                            {isWinner && (
                              ...
                              >
                                ...
                                <span className="font-mono text-[9px] tracking-[0.2em] text-amber-300 font-bold uppercase">
                                  YOUR VOTE IS IN!
                                </span>
                                <p className="text-[10px] text-zinc-400 mt-1 italic px-2 font-medium">
                        ...
                        <p className="text-zinc-400 text-[11px] leading-relaxed font-sans mb-5 font-medium">
                      ...
                      <button
                        ...
                        className={`w-full py-2 rounded-lg font-sans text-[10px] tracking-widest font-bold uppercase transition-all duration-300 flex items-center justify-center gap-1.5 cursor-pointer ${
                          isWinner
