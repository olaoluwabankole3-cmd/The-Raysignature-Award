      ...
      <section className="relative w-full py-24 sm:py-36 bg-[#0b0c10] border-t border-zinc-900/40 overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <motion.div
            ...
            className="mx-auto max-w-2xl bg-zinc-950/45 border border-amber-500/15 rounded-3xl p-8 sm:p-14 backdrop-blur-xl shadow-[0_20px_50px_rgba(218,176,92,0.03)]"
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-sans tracking-tight font-semibold text-zinc-100 mb-4 pl-0.5 animate-pulse">
              Nominees{" "}
            ...
            <div className="flex items-center justify-center gap-3 w-max mx-auto mb-6 py-1 px-4 rounded-md border border-amber-400/40 bg-amber-500/[0.02] shadow-[0_0_10px_rgba(245,158,11,0.05)]">
              <span className="w-1 h-1 rounded-full bg-amber-400" />
              <span className="font-mono text-[9px] tracking-widest bg-gradient-to-r from-amber-200 via-yellow-300 to-amber-400 bg-clip-text text-transparent uppercase font-bold">
                CROWNING CREATIVE EXCELLENCE • SEALED BALLOTS
              </span>
              <span className="w-1 h-1 rounded-full bg-amber-400" />
            </div>

            <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed max-w-md mx-auto mb-4 font-sans">
            ...
            <p className="text-[#d8b05c]/60 text-[10px] uppercase font-mono tracking-widest leading-loose">
