...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Registers and activates scroll animations for mobile ONLY
    gsap.registerPlugin(ScrollTrigger);
    const mm = gsap.matchMedia();

    // 1023px is the standard breakpoint for stacking mobile layout (below lg grid-cols-2)
    mm.add("(max-width: 1023px)", () => {
      // 1. Reveal (Section 2) Card Animation
      // Slide in from left (-100px) and slide out to right (100px)
      const tlReveal = gsap.timeline({
        scrollTrigger: {
          ...
          scrub: 0.8,              // Butter smooth scrubbing
          invalidateOnRefresh: true,
        }
      });

      tlReveal.fromTo("#reveal-card",
        { x: -100, opacity: 0 },
        { x: 0, opacity: 1, ease: "power2.out", duration: 1 }
      )
      .to("#reveal-card",
        { x: 100, opacity: 0, ease: "power2.in", duration: 1 },
        "+=0.8" // Keep centered and readable for the middle duration of scroll
      );

      // 2. Excellence (Section 3) Card Animation
      // Slide in from right (100px) and slide out to left (-100px)
      const tlExcellence = gsap.timeline({
        scrollTrigger: {
          trigger: "#excellence",
          start: "top bottom",     // When top of section enters bottom of viewport
          end: "bottom top",       // When bottom of section leaves top of viewport
      ...
      tlExcellence.fromTo("#excellence-card",
        { x: 100, opacity: 0 },
        { x: 0, opacity: 1, ease: "power2.out", duration: 1 }
      )
      .to("#excellence-card",
    ...
    return () => {
      mm.revert(); // Restores styles and kills triggers when resized to PC width or page changes
    };
  }, [currentPage]);
      ...
      <main className="relative z-30 pointer-events-auto overflow-x-hidden w-full">
        {currentPage === "gala" && (
          <>
            ...
            <section 
              id="welcome" 
              className="min-h-screen flex flex-col justify-between max-w-7xl mx-auto px-4 sm:px-6 md:px-16 pt-24 md:pt-32 pb-12 md:pb-24 relative"
            >
              <div className="my-auto max-w-2xl pt-6 sm:pt-12 text-center md:text-left">
                <motion.div 
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 1.2, delay: 0.2 }}
                  className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/[0.04] border border-amber-400/40 mb-6 sm:mb-8 backdrop-blur shadow-[0_0_15px_rgba(245,158,11,0.12)] mx-auto md:mx-0 text-left"
                >
                  <Sparkles className="w-3.5 h-3.5 text-amber-300 animate-pulse" />
                  <span className="font-mono text-[9px] sm:text-[10px] tracking-[0.2em] sm:tracking-[0.25em] bg-gradient-to-r from-amber-100 via-yellow-300 via-amber-400 to-yellow-600 bg-clip-text text-transparent uppercase font-extrabold drop-shadow-[0_1px_10px_rgba(253,224,71,0.1)]">
                ...
                <motion.h1 
                  ...
                  className="text-2xl sm:text-4xl md:text-6xl font-sans tracking-tight leading-tight sm:leading-none mb-6 font-semibold text-zinc-100 drop-shadow-[0_2px_28px_rgba(251,191,36,0.18)]"
                >
                  The{" "}
                ...
                <motion.p 
                  ...
                  className="text-zinc-400 text-xs sm:text-sm md:text-base leading-relaxed font-sans mb-8 max-w-lg mx-auto md:mx-0"
                >
                ...
                >
                  <a 
                    href="#reveal" 
                    className="w-full sm:w-auto group flex items-center justify-center gap-3 bg-white text-black py-3 px-6 rounded-md hover:bg-amber-400 transition-all duration-300 font-sans font-semibold text-sm cursor-pointer"
                  >
                    Reveal the Grail
            ...
            {/* Section 2: The Grand Reveal */}
            <section 
              id="reveal" 
              className="min-h-screen flex items-center max-w-7xl mx-auto px-4 sm:px-6 md:px-16 pt-[38vh] pb-12 md:py-32"
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                <div className="hidden lg:block h-2" />
                
                <div id="reveal-card" className="max-w-xl bg-zinc-950/65 border border-zinc-900/60 p-5 sm:p-8 md:p-12 rounded-2xl backdrop-blur-md shadow-[0_4px_30px_rgba(0,0,0,0.5)]">
            ...
            {/* Section 3: Celebrating Excellence */}
            <section 
              id="excellence" 
              className="min-h-screen flex items-center max-w-7xl mx-auto px-4 sm:px-6 md:px-16 pt-12 pb-[38vh] md:py-32"
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                <div id="excellence-card" className="max-w-xl bg-zinc-950/65 border border-zinc-900/60 p-5 sm:p-8 md:p-12 rounded-2xl backdrop-blur-md shadow-[0_4px_30px_rgba(0,0,0,0.5)]">
                  <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/[0.04] border border-amber-400/40 mb-4 md:mb-6 shadow-[0_0_15px_rgba(245,158,11,0.12)]">
