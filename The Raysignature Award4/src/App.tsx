...
export default function App() {
  const [currentPage, setCurrentPage] = useState<"gala" | "voting" | "gallery">("gala");
  ...
  // Premium auto-playing event slides matching clean, architectural aesthetic
  const CURTAIN_SLIDES = [
    {
      id: "slide-aesthetic",
      tag: "OUR AESTHETIC",
      banner: "Minimalist Precision",
      heading: "Inspired by Modern Architectural Forms",
      buttonText: "VIEW THE VISION",
      target: "reveal",
      page: "gala",
      bgImage: "https://lh3.googleusercontent.com/d/1lPtxbLAKQcr5sXsLJAefUAxbHXIYl9U6"
    },
    {
      id: "slide-selection",
      tag: "THE SELECTION",
      banner: "Strict Peer Review",
      heading: "Curated by Industry Professionals",
      buttonText: "GO TO BALLOTS",
      target: "top",
      page: "voting",
      bgImage: "https://lh3.googleusercontent.com/d/1N7qU4IVRUJ8MZ-c1bqz2omak4IeOdcLH"
    },
    {
      id: "slide-gala",
      tag: "THE GALA",
      banner: "Annual Gathering",
      heading: "A Night Celebrating Creative Excellence",
      buttonText: "VIEW THE GALLERY",
      target: "winners",
      page: "gala",
      bgImage: "https://lh3.googleusercontent.com/d/1Rf_2ZUy7UGwTtL38Lf8xZI4yMuVh04hh"
    },
    {
      id: "slide-signature",
      tag: "OUR SIGNATURE",
      banner: "Since 2022",
      heading: "Honoring the Visionaries of Our Time",
      buttonText: "READ OUR STORY",
      target: "our-story",
      page: "gala",
      bgImage: "https://lh3.googleusercontent.com/d/1ZXjzeRD1_WidvL1_Vp_hUlsCD8utnXkI"
    },
    {
      id: "slide-excellence",
      tag: "THE MASTERY",
      banner: "Absolute Precision",
      heading: "Celebrating the Pinnacle of Creative Dedication",
      buttonText: "EXPLORE THE ARCHIVE",
      target: "winners",
      page: "gala",
      bgImage: "https://lh3.googleusercontent.com/d/1n3cSOOBE1L_LxErF2GWs98ACrZbFgERL"
    }
  ];
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setSlideIndex((prev) => (prev + 1) % CURTAIN_SLIDES.length);
    }, 5000);
  ...
  useEffect(() => {
    ...
    if (heroSpotlightRef.current) {
      pulseTween = gsap.to(heroSpotlightRef.current, {
        scale: 1.15,
        opacity: 1.25,
        duration: 3.5,
        yoyo: true,
  ...
  // Countdown State (Set to a past date to show countdown completed at zero)
  const targetDate = new Date("2022-11-20T18:00:00Z").getTime();
  ...
  useEffect(() => {
    ...
    const handleUnhandledRejection = (event: PromiseRejectionEvent) => {
      ...
      if (
        ...
        reason.includes("Failed to get initial state") ||
  ...
  return (
    <div className="relative min-h-screen bg-[#12072B] text-zinc-100 selection:bg-amber-500 selection:text-black overflow-x-hidden">
      ...
      <AnimatePresence>
        {showPreloader && (
          <motion.div
            ...
            className="fixed inset-0 w-full h-full bg-[#12072B] z-[9999] flex flex-col items-center justify-center p-6"
          >
            <motion.div
            ...
            >
              <div className="relative flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 rounded-full border border-amber-500/20 bg-[#12072B]/40 backdrop-blur-md mb-6 sm:mb-8">
      ...
      >
        {/* Cinematic Luxury Light Rays Backdrop (Fanning up from pedestal area) - Removed for a flat, solid, clean deep purple background */}
      ...
      <div className="fixed inset-0 bg-gradient-to-t from-[#12072B] via-transparent to-black/80 pointer-events-none z-10" />
      ...
      <header 
        style={{ zIndex: 100 }} 
        className="fixed top-0 left-0 w-full bg-[#12072B]/60 backdrop-blur-[12px] border-b border-zinc-900/60 py-5 sm:py-6 px-4 sm:px-6 md:px-16 flex items-center justify-between overflow-visible"
      >
        <div className="w-full max-w-7xl mx-auto flex items-center justify-between overflow-visible">
          <button 
            ...
            className="relative flex items-center text-left focus:outline-none cursor-pointer group z-50 h-10 sm:h-12 w-20 sm:w-24 overflow-visible"
          >
            <img 
              src="https://lh3.googleusercontent.com/d/1VgvmbNvKU5UKjXBVwKZndepQ3Fp0z8RN" 
              alt="The Achievers Awards Logo" 
              className="absolute left-0 top-1/2 -translate-y-1/2 h-20 sm:h-24 w-auto max-w-none object-contain transition-all duration-300 group-hover:scale-105"
          ...
          <nav className="hidden md:flex items-center gap-8 text-[11px] font-mono tracking-widest text-zinc-400">
            ...
            <button 
              ...
              className={`hover:text-amber-300 tracking-[0.15em] transition-colors cursor-pointer uppercase ${currentPage === "gallery" ? "bg-gradient-to-r from-amber-100 to-amber-300 bg-clip-text text-transparent font-bold" : ""}`}
            >
              Gallery
            </button>
            <button 
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-x-0 top-[65px] bg-[#1A0B36]/95 border-b border-zinc-900 backdrop-blur-xl z-50 flex flex-col p-6 gap-5 font-mono text-xs tracking-widest text-zinc-300 md:hidden"
          >
            <button
              type="button"
              onClick={() => navigateToSection("welcome")}
            ...
            <button
              type="button"
              onClick={() => { setMobileMenuOpen(false); setCurrentPage("gallery"); window.scrollTo({ top: 0, behavior: "smooth" }); }}
              className={`text-left py-2 hover:text-amber-400 border-b border-zinc-900 pb-2 cursor-pointer ${currentPage === "gallery" ? "text-amber-400 font-bold" : ""}`}
            >
              GALLERY
            </button>
            <button
      ...
      <main className="relative z-30 pointer-events-auto overflow-x-hidden w-full">
        {currentPage === "gala" && (
          <>
            {/* The Achievers-Style Cover Layer (The Curtain) */}
            <section
              id="gala-curtain"
              className="relative h-screen w-full z-[60] flex flex-col justify-between select-none overflow-hidden border-b border-zinc-900 px-4 md:px-16 pt-44 sm:pt-52 pb-8 md:pb-12"
            >
              {/* Premium Luxury Cinematic Background Image & Gradient Overlays */}
              <div className="absolute inset-0 z-0 select-none pointer-events-none">
                <AnimatePresence mode="wait">
                  <motion.img 
                    key={slideIndex}
                    src={CURTAIN_SLIDES[slideIndex].bgImage}
                    alt="Cinematic Opulence"
                    referrerPolicy="no-referrer"
                ...
                {/* Smooth vibrant high-saturation gradient color masks matching Deep Velvet Purple and Elegant Gold */}
                <div className="absolute inset-0 bg-gradient-to-r from-[#12072B]/90 via-[#1A0B36]/60 to-[#D8B05C]/15 mix-blend-multiply" />
                <div className="absolute inset-0 bg-[#1A0B36]/35 mix-blend-color" />
                <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-[#12072B]/85 to-[#12072B]" />
                <div className="absolute inset-x-0 bottom-0 h-48 bg-gradient-to-t from-[#12072B] to-transparent" />
              </div>

              {/* Dynamic Slideshow content layout */}
              <div className="relative z-10 my-auto flex flex-col lg:flex-row w-full max-w-7xl mx-auto px-4 sm:px-12 items-center justify-between gap-12 text-left">
                {/* Left Side Content - Bold image headings */}
                <div className="w-full lg:w-3/5">
                  <AnimatePresence mode="wait">
                    ...
                    >
                      {/* Split/Layout containing Vertical text & Banner */}
                      <div className="flex items-start gap-5 sm:gap-8">
                        
                        {/* Vertical Tag */}
                        <div 
                          style={{ writingMode: 'vertical-rl' }}
                          className="font-mono text-[9px] sm:text-[10px] text-amber-400 tracking-[0.35em] uppercase border-r border-amber-400/20 pr-4 py-1 select-none font-bold"
                        >
                          {CURTAIN_SLIDES[slideIndex].tag}
                        </div>

                        {/* Banner Block */}
                        <div className="flex items-center">
                          <span className="font-sans font-black text-xl sm:text-2xl md:text-3xl lg:text-4xl text-[#facc15] tracking-[0.05em] uppercase select-none drop-shadow-[0_4px_20px_rgba(250,204,21,0.2)] leading-none">
                            {CURTAIN_SLIDES[slideIndex].banner}
                          </span>
                        </div>
                      </div>

                      {/* Big Main Heading */}
                      <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-sans tracking-tight leading-snug sm:leading-none text-white font-black uppercase max-w-xl select-none drop-shadow-[0_4px_30px_rgba(0,0,0,0.5)]">
                        {CURTAIN_SLIDES[slideIndex].heading}
                      </h1>
                      ...
                      <div>
                        <button
                          onClick={() => {
                            const slide = CURTAIN_SLIDES[slideIndex];
                            if (slide.page === "voting") {
                              setCurrentPage("voting");
                              window.scrollTo({ top: 0, behavior: "smooth" });
                            } else if (slide.target) {
                              navigateToSection(slide.target);
                            }
                          }}
                          className="px-8 py-3.5 bg-[#facc15] hover:bg-yellow-400 text-black font-sans font-black text-xs sm:text-sm tracking-[0.25em] uppercase rounded-none transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] cursor-pointer shadow-[0_4px_30px_rgba(250,204,21,0.3)] hover:shadow-[0_4px_45px_rgba(250,204,21,0.5)]"
                        >
                          {CURTAIN_SLIDES[slideIndex].buttonText}
                        </button>
                      </div>
                ...
                {/* Right Side - Interactive Slide Indicators or Elegant Digital Clock Card */}
                <div className="w-full lg:w-2/5 flex flex-col items-center lg:items-end justify-center">
                  
                  {/* Slide Indicators & Controls */}
                  <div className="flex flex-col items-center lg:items-end gap-3">
                    <span className="font-mono text-[8px] text-amber-400/60 uppercase tracking-[0.25em]">
                      EXPLORE SECTIONS
                    </span>
                    <div className="flex gap-2.5">
                      {CURTAIN_SLIDES.map((slide, idx) => (
                        <button
                          key={slide.id}
                          onClick={() => setSlideIndex(idx)}
                          className={`w-8 h-1 transition-all duration-300 cursor-pointer ${slideIndex === idx ? "bg-[#facc15] w-14" : "bg-white/20 hover:bg-white/40"}`}
              ...
              {/* Signature flowing abstract gold wave graphics or smooth curved SVG borders */}
              <div className="absolute bottom-0 left-0 right-0 h-28 overflow-hidden pointer-events-none z-20">
                <svg className="absolute bottom-0 w-full h-full" viewBox="0 0 1440 120" fill="none" preserveAspectRatio="none">
                  <path d="M0,60 C360,110 720,10 1080,80 C1200,100 1320,110 1440,90 L1440,120 L0,120 Z" fill="#D8B05C" opacity="0.15" />
                  <path d="M0,80 C360,20 720,100 1080,40 C1200,20 1320,50 1440,70 L1440,120 L0,120 Z" fill="#1A0B36" opacity="0.7" />
                  <path d="M0,95 C360,115 720,45 1080,105 C1200,120 1320,95 1440,100 L1440,120 L0,120 Z" fill="#D8B05C" opacity="0.35" />
                  <path d="M0,110 C360,70 720,115 1080,90 C1200,80 1320,110 1440,95 L1440,120 L0,120 Z" fill="#D8B05C" opacity="0.75" />
                </svg>
              </div>
            ...
            <section 
              id="welcome" 
              className="min-h-screen flex flex-col justify-between max-w-7xl mx-auto px-4 md:px-16 pt-44 sm:pt-56 pb-12 md:pb-24 relative z-50"
            >
              <div className="my-auto max-w-4xl mx-auto pt-6 md:pt-12 text-center flex flex-col items-center">
                <motion.div 
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 1.2, delay: 0.2 }}
                  className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/[0.04] border border-amber-400/40 mb-6 md:mb-8 backdrop-blur shadow-[0_0_15px_rgba(245,158,11,0.12)] mx-auto"
                >
                ...
                <motion.h1 
                  ...
                  className="text-3xl sm:text-5xl md:text-6xl font-sans tracking-tight leading-tight md:leading-none mb-10 font-semibold text-zinc-100 drop-shadow-[0_2px_28px_rgba(251,191,36,0.18)]"
                >
                  The{" "}
                ...
                {/* Minimalist Grid of Core Categories */}
                <motion.div 
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 1.5, delay: 0.6 }}
                  className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 w-full max-w-4xl mb-12"
                >
                  {[
                    { num: "01", title: "DIGITAL SPATIAL DESIGN" },
                    { num: "02", title: "HAUTE COUTURE" },
                    { num: "03", title: "MODERN ARCHITECTURE" }
                  ].map((cat, index) => (
                    <div 
                      key={index}
                      className="p-6 rounded-2xl border border-white/[0.04] bg-white/[0.02] backdrop-blur-md flex flex-col items-center justify-center text-center transition-all duration-300 hover:border-[#D8B05C]/30 hover:bg-white/[0.04] group shadow-[0_4px_30px_rgba(0,0,0,0.2)]"
                    >
                      <span className="font-display italic text-2xl text-[#D8B05C] mb-2 font-light group-hover:scale-110 transition-transform duration-300 block">
                        {cat.num}
                      </span>
                      <span className="font-sans text-xs sm:text-sm tracking-[0.2em] text-zinc-200 font-bold group-hover:text-white transition-colors duration-300 leading-relaxed block">
                        {cat.title}
                      </span>
                    </div>
                  ))}
                ...
                >
                  <button 
                    ...
                    className="w-full sm:w-auto min-w-[280px] group flex items-center justify-center gap-3 bg-white text-[#12072B] py-4 px-8 rounded-full hover:bg-amber-400 transition-all duration-300 font-sans font-black text-xs sm:text-sm tracking-[0.2em] uppercase cursor-pointer shadow-[0_4px_30px_rgba(255,255,255,0.15)] hover:shadow-[0_4px_45px_rgba(250,204,21,0.4)]"
                  >
                    <span>EXPLORE ALL CATEGORIES</span>
                    <ArrowRight className="w-4 h-4 group-hover:translate-x-1.5 transition-transform text-[#12072B]" />
                  </button>
            ...
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                ...
                <div id="reveal-card" className="max-w-xl bg-zinc-950/65 border border-zinc-900/60 p-5 md:p-12 rounded-2xl backdrop-blur-md shadow-[0_4px_30px_rgba(0,0,0,0.5)]">
                  ...
                  <p className="text-zinc-400 text-xs sm:text-sm md:text-base leading-relaxed mb-5 md:mb-8 font-medium">
                    {AWARDS_CONFIG.sections[1].description}
                  </p>

                  <div className="grid grid-cols-2 gap-4 sm:gap-6 pt-4 md:pt-6 border-t border-zinc-900">
                    <div>
                      <div className="text-lg sm:text-xl md:text-2xl font-sans font-semibold text-amber-400">Loved Globally</div>
                      <div className="text-[9px] sm:text-[10px] uppercase font-mono tracking-wider text-zinc-500 mt-1 font-bold">
                        POPULAR WORLDWIDE
                      </div>
                    </div>
                    <div>
                      <div className="text-lg sm:text-xl md:text-2xl font-sans font-semibold text-amber-400">Certified Winner</div>
                      <div className="text-[9px] sm:text-[10px] uppercase font-mono tracking-wider text-zinc-500 mt-1 font-bold">
                        REAL AWARDS
                      </div>
                    </div>
              ...
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                <div id="excellence-card" className="max-w-xl bg-zinc-950/65 border border-zinc-900/60 p-5 md:p-12 rounded-2xl backdrop-blur-md shadow-[0_4px_30px_rgba(0,0,0,0.5)]">
                  ...
                  <div className="p-3 md:p-4 bg-amber-500/5 border border-amber-400/10 rounded-lg flex items-start gap-3 sm:gap-4">
                    ...
                    <div>
                      <div className="text-[10px] sm:text-xs font-semibold text-zinc-200 uppercase font-mono tracking-wide font-bold">
                        Real Winners
                      </div>
                      <p className="text-[10px] sm:text-[11px] text-zinc-400 mt-1 leading-normal font-medium">
                        Every winner is chosen carefully by experts, making sure we only celebrate the best creators.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {/* Our Story Editorial Narrative Section */}
            <OurStory />
          </>
        )}
        ...
        {/* Section 5: Dedicated Awards Gallery Page */}
        {currentPage === "gallery" && (
          <AwardsGallery />
        )}
      ...
      <AnimatePresence>
        {revealExpanded && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[200] w-full h-full bg-[#12072B]/95 backdrop-blur-xl flex items-center justify-center p-4 md:p-8"
          >
            <motion.div
              ...
              <div className="relative z-10 pt-4 flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-4 pt-3 mt-1 border-t border-zinc-900/80">
                  <div className="bg-zinc-900/30 border border-zinc-900/40 p-3 rounded-2xl">
                    <div className="text-xs sm:text-sm font-sans font-semibold text-amber-400 leading-none">Loved Globally</div>
                    <div className="text-[7px] uppercase font-mono tracking-wider text-zinc-500 mt-1 font-bold">WORLDWIDE</div>
                  </div>
                  <div className="bg-zinc-900/30 border border-zinc-900/40 p-3 rounded-2xl">
                    <div className="text-xs sm:text-sm font-sans font-semibold text-amber-400 leading-none">Certified Winner</div>
                    <div className="text-[7px] uppercase font-mono tracking-wider text-zinc-500 mt-1 font-bold">REAL AWARDS</div>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10 pt-4 flex flex-col gap-4">
                ...
                <div className="bg-amber-500/5 border border-amber-400/10 rounded-2xl items-start gap-3 flex p-4 mt-2">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-zinc-200 uppercase font-mono tracking-wide leading-none font-bold">
                      Real Winners
                    </div>
