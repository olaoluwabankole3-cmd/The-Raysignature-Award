...
export default function TimelineShowcase() {
  ...
  return (
    <section
      ref={containerRef}
      id="winners"
      className="relative w-full py-20 sm:py-32 bg-[#12072B] border-t border-zinc-900/40 overflow-hidden select-none"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-16 relative z-10 mb-12 sm:mb-20">
        <div className="max-w-3xl text-center md:text-left select-none">
          ...
          <p className="text-zinc-400/90 text-xs sm:text-sm leading-relaxed font-sans max-w-xl font-medium">
            Scroll up and down on the page to watch these beautiful pictures slide left and right. Use your mouse wheel or finger to see the motion!
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-16 relative z-10 mt-10 sm:mt-16 text-center md:text-left">
        <div className="inline-flex items-center gap-2 text-zinc-500 font-mono text-[9px] uppercase tracking-wider">
          ...
          <span>These rows move automatically as you scroll down the page!</span>
        </div>
      </div>
    </section>
  );
